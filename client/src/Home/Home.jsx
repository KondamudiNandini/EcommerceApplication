...
export default function Home() {
  ...
  async function fetchProducts(){
    await axios.get("https://ecommerceapplication-1-eusm.onrender.com/api/product")
      .then((res)=>{
        console.log(res)
  ...
  async function addCart(productId){
    ...
    try{
      await axios.post("https://ecommerceapplication-1-eusm.onrender.com/api/cart/add",{productId},{
